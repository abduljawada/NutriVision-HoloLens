...
namespace YoloHolo.Services
{
    ...
    {
        public static List<YoloItem> GetYoloData(this Tensor<float> tensor, IYoloClassTranslator translator, 
            float minProbability, float overlapThreshold)
        {
            return tensor.ProcessItem(translator, minProbability, overlapThreshold);  
        }

        private static List<YoloItem> ProcessItem(this Tensor<float> tensor, IYoloClassTranslator translator,
            float minProbability, float overlapThreshold)
        {
            ...
            {
                var yoloItem = YoloItem.Create(tensor, i, translator);
